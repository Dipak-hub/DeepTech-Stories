...
function StoryVideo({ url, paused, onLoad }) {
    const player = (0, expo_video_1.useVideoPlayer)(url, p => {
        p.loop = true;
        p.play();
    });
    (0, react_1.useEffect)(() => {
    ...
    return (<expo_video_1.VideoView player={player} style={react_native_1.StyleSheet.absoluteFill} contentFit="cover" onFirstFrameRender={() => {
